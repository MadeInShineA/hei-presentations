...
Minimize $\frac{1}{2}||\mathbf{w}||^2$ (max margin)
...
All use kernels; choose based on task
...
Implicit high-dim mapping without computation.
...
Start with linear; switch if needed
...
High C + High Gamma = Overfit risk
...
Higher = more complex (overfit risk)
...
Robust for text/images; test on your data!
...
- [Support Vector Machines Guide](https://www.cs.cornell.edu/people/tj/publications/joachims_98a.pdf)
- [Kernel Methods](https://en.wikipedia.org/wiki/Kernel_method)

:::{.notes}
Key sources for further reading on SVMs.
:::
